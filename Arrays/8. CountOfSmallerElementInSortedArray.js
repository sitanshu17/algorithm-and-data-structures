...
const CountOfSmallerElementUsingBinarySearch = (arr, x) => {
    let count = 0;
    let left = 0;
    let right = arr.length - 1;
...
const arr = [1, 2, 2, 2, 5, 7, 9];
console.log('Count of smaller element: ', CountOfSmallerElement(arr, 2));
console.log('Count of smaller element: ', CountOfSmallerElementUsingBinarySearch(arr, 2));
